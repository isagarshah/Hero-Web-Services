package com.example.superherowebservices;
	...
	private class GetHeroesTask extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				JSONArray heroesJSONArray = jsonObj.getJSONArray("heroes");
				...
				for (int i = 0; i < heroesJSONArray.length(); i++) {
					...
					String curThumb = curHeroJsonObj.getString("thumbnail");
					
					Hero curHero = new Hero(curName, curDesc, curThumb);
					heroes.add(curHero);
				}
